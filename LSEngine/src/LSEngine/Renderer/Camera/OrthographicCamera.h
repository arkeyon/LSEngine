...
namespace LSE {
	...
	{
	public:
		OrthoCamera3D(glm::vec3 pos, glm::vec3 angles, float ar = 16.f / 9.f, float xmin = -50.f, float xmax = 50.f, float ymin = -50.f, float ymax = 50.f, float zmin = -50.f, float zmax = 20.f);
